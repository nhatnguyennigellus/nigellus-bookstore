...
<body>
	<form:form id="mainForm" method="post" commandName="model">
		...
		<form:select path="batch.id">
			<form:options items="${model.batches}" itemValue="id"
				itemLabel="name" />
		</form:select>
		<br />
		<br />
	...
	<c:if test="${sessionScope.addStudentSuccess != null}">
		<font color="green">${sessionScope.addStudentSuccess }</font>
	</c:if>
