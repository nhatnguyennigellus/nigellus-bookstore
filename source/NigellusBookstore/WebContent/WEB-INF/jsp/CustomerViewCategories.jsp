...
<body>
	<form:form id="mainForm" method="post" commandName="model">
		<div class="col-md-12">
			...
			<br />
			<h3>${model.selectedCategory.name.toUpperCase() }</h3>
			<div class="panel panel-info">
				<div class="panel-body">${model.selectedCategory.description}
				</div>
			</div>
		</div>
		<div class="col-md-12">
							...
							<tr>
									...
									<ol class="carousel-indicators">
										...
										<c:forEach items="${sessionScope.GALLERY }" var="img"
											...
											<c:if test="${img.book.id == book.id }">
												<li data-target="#myCarousel${book.id }"
													data-slide-to="${no.count }"></li>
											</c:if>
										</c:forEach>
								...
								<td>
									...
									<h2 style="color: green; font-weight: bold; text-align: right;">
										${book.unitPrice.toString().replace('.0','')}&nbsp;VND</h2> <c:url
										var="urlCart" value="addToCart">
